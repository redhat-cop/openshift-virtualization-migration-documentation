...
| A link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/html-single/installing_on_openshift_container_platform/index#assembly-aap-activate[Red Hat Service Account] or link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/html-single/installing_on_openshift_container_platform/index#proc-aap-activate-with-manifest[Red Hat Subscriptions Manifest file] with Ansible Automation Platform entitlements is required in order to activate Ansible Automation Platform.
...
1. link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/html-single/installing_on_openshift_container_platform/index#assembly-aap-activate[Red Hat Service Account]
2. link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.7/html-single/installing_on_openshift_container_platform/index#proc-aap-activate-with-manifest[Red Hat Subscriptions Manifest file]
