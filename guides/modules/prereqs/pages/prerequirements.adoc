...
| A link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/installing_on_openshift_container_platform/index#assembly-aap-activate[Red Hat Service Account] or link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/installing_on_openshift_container_platform/index#proc-aap-activate-with-manifest[Red Hat Subscriptions Manifest file] with Ansible Automation Platform entitlements is required in order to activate Ansible Automation Platform.
...
1. link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/installing_on_openshift_container_platform/index#assembly-aap-activate[Red Hat Service Account]
2. link:https://docs.redhat.com/en/documentation/red_hat_ansible_automation_platform/2.6/html-single/installing_on_openshift_container_platform/index#proc-aap-activate-with-manifest[Red Hat Subscriptions Manifest file]
...
Consult the xref:appendix:appendix.adoc#github-credentials[Appendix] for the steps to configure these resources for use.
...
[,shell]
----
sudo subscription-manager repos --enable ansible-automation-platform-2.6-for-rhel-$(rpm --eval %rhel)-x86_64-rpms
----

[NOTE]
====
The command above adds the Ansible Automation Platform 2.6 repository. To install an alternate version (such as 2.5), change the version in the command to target the desired version.
====
